...
namespace AuthMe
{
    public class Login : MonoBehaviour
    {
        ...
        private void Update()
        {
            if (LoginButtonArea.Contains(Event.current.mousePosition))
            {
        ...
        private void OnGUI()
        {
            ...
            UserName = GUI.TextField(new Rect(60, 60, 130, 20), UserName);
            Password = GUI.TextField(new Rect(60, 90, 130, 20), Password);
            ...
            if (!UnderLogin)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (request == "Approved")
                        {
                            if (AuthMe.Instance._login != null)
                            {
                                UnityEngine.Object.Destroy(AuthMe.Instance.AuthGameObject);
                            }
                        }
